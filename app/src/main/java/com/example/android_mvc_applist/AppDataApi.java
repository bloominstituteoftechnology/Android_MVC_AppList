...
public class AppDataApi
{
    ...
    private static void parseRawData(ArrayList<appModel> dataModels, String dataString)
    {
        ...
        for (int i = 0; i < lines.length; i++) {
            ...
            dataModels.add(new appModel(Integer.parseInt(splitLine[0]),
                    splitLine[1],
                    splitLine[2],
                    splitLine[3],
                    splitLine[4]));
...
private static final String RAW_DATA_1 = "1,Tresom,0.18,php.net,bboick0@bravesites.com,http://dummyimage.com/169x140.jpg/dddddd/000000\n"+
    ...
    private static final String RAW_DATA_2 = "251,Matsoft,4.4,wired.com,csherrock6y@narod.ru,http://dummyimage.com/215x221.bmp/cc0000/ffffff\n"+
